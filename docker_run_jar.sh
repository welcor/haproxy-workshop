...
echo "Running 'docker run --hostname $1 --name $CONTAINER_NAME -p $1:$2:$2 -d -v /vagrant:/opt/vagrant -it dockerfile/java:oracle-java8 java -jar /opt/vagrant/$3'"
CID="$(docker run --hostname $1 --name $CONTAINER_NAME -p $1:$2:$2 -d -v /vagrant:/opt/vagrant -it dockerfile/java:oracle-java8 java -jar /opt/vagrant/$3 )"
echo
echo
echo "Taile loggen: "
